...
class LossComputeBase(nn.Module):
    ...
    def sharded_compute_loss(self, batch, output,
        ...
        loss, stats = self._compute_loss(batch, output, [batch.tgt_user[:, 1:], batch.tgt_agent[:, 1:]], scores)
        for i in range(2):
...
class NMTLossCompute(LossComputeBase):
    ...
    def _compute_loss(self, batch, output, target, score=None):
        losses, stats = [], []
        for i in range(2):
        ...
        if score is not None:
            ...
            # exit()
            # concat different layer results
